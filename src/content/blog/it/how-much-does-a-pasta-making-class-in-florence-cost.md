...
1. **Dimensione del gruppo.** Un corso di 20 persone con due postazioni demo costa meno di un tavolo di 8 con uno chef accanto a te. Se un prezzo sembra troppo bello, di solito il motivo è la dimensione del gruppo. Chiedi sempre il numero massimo.
2. **Cosa cucini — e se lo mangi.** Una demo di un solo formato costa meno di un corso in cui prepari l'intero pasto e poi ti siedi a mangiarlo. Il pasto seduti (con vino) è dove un corso si trasforma in un pranzo o una cena, il che conta quando confronti i prezzi con un pasto al ristorante che pagheresti altrimenti.
...
## I nostri prezzi, come esempio concreto
...
1. **Qual è la dimensione massima del gruppo?** Questo singolo numero prevede la tua esperienza meglio di qualsiasi altra cosa. Sopra le 12 persone, guardi più che cucinare.
2. **Chi insegna effettivamente?** Uno chef che cucina per vivere, o un host che segue un copione? Chiedi cosa fa l'insegnante quando non insegna.
3. **Mangiamo quello che facciamo e il vino è incluso?** Se no, sottrai il costo di un pasto al ristorante dal valore.
...
Se vuoi vedere come funziona il nostro tavolo prima di decidere, inizia con **[Il Tavolo dello Chef](/it/corso-pasta-fresca-firenze/)** — è il corso su cui si basa tutto il resto che facciamo.
