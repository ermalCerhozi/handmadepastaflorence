const fr = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Combien de temps dure un atelier de pâtes fraîches ?', a: 'La Table du Chef dure environ 3 heures ; Marché & Mains (avec la visite du marché à l\'aube) dure environ 5 heures. Chaque cours se termine par un déjeuner assis avec ce que vous avez préparé.' },
      ...
      { q: 'Y a-t-il des cours de cuisine de pâtes privés à Florence ?', a: 'Oui. Les entreprises et les groupes peuvent réserver toute la cuisine pour un cours privé de la Grande Table Familiale (6 à 14 personnes). Nous proposons également des tarifs partenaires et des réservations de recommandation pour les hôtels, les agritourismes et les voyagistes.' },
      { q: 'Combien coûte un cours de fabrication de pâtes à Florence ?', a: 'Notre cours signature La Table du Chef coûte 95 € par personne, et le cours Marché & Mains coûte 145 €. Les cours de groupe privés commencent à 680 €.' },
