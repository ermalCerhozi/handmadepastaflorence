...
const it: Dict = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: `Quanto dura un corso di pasta fresca?`, a: `Il Tavolo dello Chef dura circa 3 ore; Mercato & Mani (con il giro al mercato all'alba) dura circa 5 ore. Ogni corso si conclude con un pranzo al tavolo con ciò che hai preparato.` },
      ...
      { q: `Ci sono corsi di cucina privati a Firenze?`, a: `Sì. Le aziende e i gruppi possono prenotare l'intera cucina per un corso privato "Tavolo in Famiglia" (6-14 persone). Offriamo anche tariffe partner e prenotazioni su segnalazione per hotel, agriturismi e tour operator.` },
      { q: `Quanto costa un corso di pasta fresca a Firenze?`, a: `Il nostro corso esclusivo "Il Tavolo dello Chef" costa €95 a persona, e il corso "Mercato & Mani" costa €145. I corsi di gruppo privati partono da €680.` },
